...
namespace SageConcept.Core
{
    ...
    public abstract class BaseNotify : INotifyPropertyChanged
    {
        ...
        protected string ExtractPropertyName<T>(Expression<Func<T>> propertyExpression)
        {
            ...
            {
                throw new ArgumentException("Not a member", "propertyExpression");
            }

            var property = memberExpression.Member as PropertyInfo;
            if (property == null)
            {
                throw new ArgumentException("Member", "propertyExpression");
            }
            ...
            {
                throw new ArgumentException("Static", "propertyExpression");
            }
